...
student.classrooms.create!(name: 'Егор', user:, wage: 1200, length: 1)

student = user.students.create!(name: 'Миша', contact_details: 'мама Татьяна, +7 876 765 45 45')
student.classrooms.create(name: 'Миша', user:, wage: 1300, length: 1)

classroom = user.classrooms.create!(name: 'Upper-Intermediate', user:, wage: 1400, length: 1)
